    ...
    <section id="contact" className="min-h-screen flex items-center justify-center py-20 px-4">
      <RevealOnScroll>
        <div className="px-4 w-full md:w-[500px]">
          ...
          {isSent ? (
            <div className="w-full max-w-2xl bg-green-500/10 p-8 rounded-xl border border-green-500/20 text-center shadow-2xl">
              <h3 className="text-2xl font-bold text-green-400 mb-4">Thank You!</h3>
              <p className="text-gray-300 text-lg mb-6">Your message has been sent successfully. I'll get back to you soon!</p>
              <a 
                href="#home" 
                onClick={() => setIsSent(false)}
                className="bg-blue-600 text-white font-medium py-2 px-6 rounded hover:bg-blue-700 transition hover:-translate-y-0.5 shadow-lg shadow-blue-500/20"
              >
                Back to Portfolio
              </a>
            </div>
